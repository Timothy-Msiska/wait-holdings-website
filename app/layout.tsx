        ...
        >
          <nav className="grid h-[72px] grid-cols-3 items-center px-6">
            ...
            <div className="flex items-center justify-end gap-2">
              <Button className="hidden md:inline-flex rounded-full px-6 bg-gradient-to-r from-primary to-primary/80 shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all duration-300">
                Book Consultation
              </Button>
